...
sub wigtobigwig 
{
    ...
    system ("/lustre/home/sjxia/02_software/wigToBigWig -clip $filename.wig $bigwig_folder/$genome\_sizes.txt $filename.bw") == 0 or print STDOUT "couldn't bigwig $genome file $filename\n";
