...
dir=str(os.getcwd())
configfile: os.path.join(dir,'config/config_clean.yaml')

##########################################
## Sample information
##########################################
sample_file=dir+"/"+"3c_sample_info.csv"
...
rule all:
    input:
        ...
        ## venus
        #venus_out=expand(outdir+"/10_venus/"+"{sample}"+"/detection/bulk_paired-end/detection_output.tsv",sample=sample_list)
        ## venus stimulate
        unmap_R1=expand(outdir+"/11_venus_stimulate/"+"output/"+"{sample}"+"/"+"Unmapped.out.mate1",sample=sample_list),
        unmap_R2=expand(outdir+"/11_venus_stimulate/"+"output/"+"{sample}"+"/"+"Unmapped.out.mate2",sample=sample_list)
...
## venus
#include: "rules/10_ebv_virus.py"

## venus stimulation
include: "rules/11_star_human_virus.py"